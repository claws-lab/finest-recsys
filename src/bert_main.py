...
def main():
    ...
    [original_logits,reference_list,competitive_items, original_perf] = trainer.traintest(original_logits=-1, reference_list=-1,competitive_items=-1, args=args,data = original_data,mode="original_training")
    ...
    [temp1,temp2,temp3,perturbed_perf] = original_trainer.traintest(original_logits=original_logits, reference_list=reference_list,competitive_items=competitive_items, args=args,data = perturbed_data,mode="retraining")
